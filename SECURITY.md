...
1. Open the [Security tab](https://github.com/raylsnetwork/rayls-sovereign-pnh-auditor-ui/security) of this repository.
...
This policy covers the `rayls-sovereign-pnh-auditor-ui` application in this repository. It is a
client of the Rayls governance/backend API; vulnerabilities in those services should be reported
...
The application is under active development. Security fixes are released against the **latest
release**; users are strongly encouraged to always run the latest version.
